...
func (wc *WorkspaceCreate) AddConnectionIDs(ids ...uuid.UUID) *WorkspaceCreate {
	wc.mutation.AddConnectionIDs(ids...)
	return wc
}

// AddConnections adds the "connections" edges to the Connection entity.
func (wc *WorkspaceCreate) AddConnections(c ...*Connection) *WorkspaceCreate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return wc.AddConnectionIDs(ids...)
}
