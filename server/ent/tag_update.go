...
func (tu *TagUpdate) SetConnectionID(u uuid.UUID) *TagUpdate {
	tu.mutation.SetConnectionID(u)
	return tu
}

// SetNillableConnectionID sets the "connection_id" field if the given value is not nil.
func (tu *TagUpdate) SetNillableConnectionID(u *uuid.UUID) *TagUpdate {
	if u != nil {
		tu.SetConnectionID(*u)
	}
	return tu
}

// SetConnectionsID sets the "connections" edge to the Connection entity by ID.
func (tu *TagUpdate) SetConnectionsID(id uuid.UUID) *TagUpdate {
	tu.mutation.SetConnectionsID(id)
	return tu
}

// SetConnections sets the "connections" edge to the Connection entity.
func (tu *TagUpdate) SetConnections(c *Connection) *TagUpdate {
	return tu.SetConnectionsID(c.ID)
}
...
func (tu *TagUpdate) ClearConnections() *TagUpdate {
	tu.mutation.ClearConnections()
	return tu
}
...
func (tu *TagUpdate) check() error {
	...
	if tu.mutation.ConnectionsCleared() && len(tu.mutation.ConnectionsIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Tag.connections"`)
	}
	return nil
}
...
func (tu *TagUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.ConnectionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   tag.ConnectionsTable,
			Columns: []string{tag.ConnectionsColumn},
			Bidi:    false,
	...
	if nodes := tu.mutation.ConnectionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   tag.ConnectionsTable,
...
// SetConnectionID sets the "connection_id" field.
func (tuo *TagUpdateOne) SetConnectionID(u uuid.UUID) *TagUpdateOne {
	tuo.mutation.SetConnectionID(u)
	return tuo
}

// SetNillableConnectionID sets the "connection_id" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableConnectionID(u *uuid.UUID) *TagUpdateOne {
	if u != nil {
		tuo.SetConnectionID(*u)
	}
	return tuo
}

// SetConnectionsID sets the "connections" edge to the Connection entity by ID.
func (tuo *TagUpdateOne) SetConnectionsID(id uuid.UUID) *TagUpdateOne {
	tuo.mutation.SetConnectionsID(id)
	return tuo
}

// SetConnections sets the "connections" edge to the Connection entity.
func (tuo *TagUpdateOne) SetConnections(c *Connection) *TagUpdateOne {
	return tuo.SetConnectionsID(c.ID)
}
...
// ClearConnections clears the "connections" edge to the Connection entity.
func (tuo *TagUpdateOne) ClearConnections() *TagUpdateOne {
	tuo.mutation.ClearConnections()
	return tuo
}
...
func (tuo *TagUpdateOne) check() error {
	...
	if tuo.mutation.ConnectionsCleared() && len(tuo.mutation.ConnectionsIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Tag.connections"`)
	}
	return nil
}
...
func (tuo *TagUpdateOne) sqlSave(ctx context.Context) (_node *Tag, err error) {
	...
	if tuo.mutation.ConnectionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   tag.ConnectionsTable,
	...
	if nodes := tuo.mutation.ConnectionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   tag.ConnectionsTable,
