...
func (e PersonEdges) MemoriesOrErr() ([]*Memory, error) {
	if e.loadedTypes[0] {
...
// QueryMemories queries the "memories" edge of the Person entity.
func (pe *Person) QueryMemories() *MemoryQuery {
	return NewPersonClient(pe.config).QueryMemories(pe)
}
