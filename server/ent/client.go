...
func (c *MemoryClient) UpdateOne(m *Memory) *MemoryUpdateOne {
	mutation := newMemoryMutation(c.config, OpUpdateOne, withMemory(m))
...
func (c *MemoryClient) DeleteOne(m *Memory) *MemoryDeleteOne {
