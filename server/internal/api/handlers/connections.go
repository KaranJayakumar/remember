...
func (h *ConnectionHandler) List() gin.HandlerFunc {
...
func (h *ConnectionHandler) Create() gin.HandlerFunc {
	return func(c *gin.Context) {
		workspaceID := c.Param("workspace_id")
		if _, err := uuid.Parse(workspaceID); err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "invalid workspace_id"})
...
func (h *ConnectionHandler) Delete() gin.HandlerFunc {
	return func(c *gin.Context) {
...
func (h *ConnectionHandler) Get() gin.HandlerFunc {
	return func(c *gin.Context) {
		connectionID := c.Param("connection_id")
		if _, err := uuid.Parse(connectionID); err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "invalid connection_id"})
